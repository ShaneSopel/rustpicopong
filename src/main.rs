...
fn main() -> !
{
    ...
    loop {  
      ...
      while n < 101
        {
          // Draw a filled square
        let mut paddle1 =  Rectangle::with_corners(Point::new(2, 50+n), Point::new(2+16, 100+n))
          .into_styled(PrimitiveStyle::with_stroke(Rgb565::GREEN, 1))
          .draw(&mut disp)
          .unwrap();
      
        let mut paddle2 =  Rectangle::with_corners(Point::new(142, 50+ n ), Point::new(142 + 16, 100+n))
          .into_styled(PrimitiveStyle::with_stroke(Rgb565::GREEN, 1))
          .draw(&mut disp)
          .unwrap();
